    ...
    window.addEventListener('keydown', (event) => {
        ...
        if(!curKeysPressed.includes(event.key)){
            ...
            if(colorSearched === randColor){
                score = numSpins;
                console.log(score);
                let recordFinger = dots.find(function(o){return o.key===event.key});
...
function spin(){
    ...
    if(curFingersActive.includes(randFinger)){
        ...
        let obj = dots.find(function(o){return o.finger===randFinger});
        ...
        switch(obj.color){
            ...
            default:
                ...
                console.log("could not find color associated with finger in list");
        }
        
    }

    //append current finger to list of fingers active
...
function findColor(array, key){
    return array.find(function(o){return o.key===key}).color;
}

function findFinger(array,key){
    return array.find(function(o){return o.key===key}).finger;
}